          ...
          <div className="space-y-6 reveal">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <address className="text-muted-foreground not-italic">Madhav flour mill, gopalpara, ranavav, porbandar</address>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex flex-wrap gap-3">
                {socialLinks.map((social, index) => <a key={index} href={social.url} target="_blank" rel="noopener noreferrer" aria-label={social.label} className="w-10 h-10 rounded-full bg-background flex items-center justify-center text-foreground border border-border hover:bg-primary hover:text-white hover:border-primary transition-colors duration-300">
                    {social.icon}
                  </a>)}
              </div>
            </div>
